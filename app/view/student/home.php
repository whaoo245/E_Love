...
<head>
    ...
    <title>Home | E Love</title>
    <link rel="stylesheet" href="<?php echo $path; ?>public/css/layout/sidebar.css?v=<?php echo time(); ?>">
    <link rel="stylesheet" href="<?php echo $path; ?>public/css/layout/question.css?v=<?php echo time(); ?>">
    <link rel="stylesheet" href="<?php echo $path; ?>public/css/student/home.css?v=<?php echo time(); ?>">
</head>
    ...
    <div class="main-sidebar-wrapper">
        ...
        <main class="home--main main-content">
            <div class="home__header">
                <h2 class="home__header-title main-title">Post Posted:
                ...
                <div class="home__header-btn-container">
                    ...
                    <button class="home__header-btn home__header-btn--ask-question dialog">
                        <a class="home__header-link" href="askQuestion.php">Add Post</a>
                    </button>
                </div>
            </div>
            <div class="home__filter-container dialog hide">
                <h3>Filter Post By: </h3>
