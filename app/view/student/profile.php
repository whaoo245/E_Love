          ...
          <main class="profile--main main-content">
               <section class="profile__banner dialog">
                    ...
                    <nav class="profile__banner-navbar">
                         ...
                         <button class="profile__banner-navbar-btn" data-section="question">Post</button>
                         <!--<button class="profile__banner-navbar-btn" data-section="answer">Response</button>-->
                         <button class="profile__banner-navbar-btn" data-section="bookmark">Save</button>
                    </nav>
               </section>
               ...
               <section class="profile-section profile-section--overview profile-section-selected--flex">
                    ...
                    <div class="profile-section__overview--stats dialog">
                         <h3 class="overview--stats__title">Status</h3>
                         <p class="profile__content">
                              <span class="profile__content-label">Point Awarded: </span>
                              <?php echo htmlspecialchars($userInfo['point']); ?>
                         </p>
                         <p class="profile__content">
                              <span class="profile__content-label">Response provided: </span>
                              <?php echo htmlspecialchars($answer->answerCount($userId)); ?>
                         </p>
                         <p class="profile__content">
                              <span class="profile__content-label">Post Posted: </span>
